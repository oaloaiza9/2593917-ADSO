...
public class ModificarUsuario extends javax.swing.JFrame {
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        for(int i = 0; i<this.ventanaMenu.indexPersona; i++){
            if(this.ventanaMenu.listaPersonas[i]!= null && this.ventanaMenu.listaPersonas[i].getCedula().equalsIgnoreCase(cedula)){
                this.ventanaMenu.listaPersonas[i].setNombres( this.campoNombres.getText() );
                this.ventanaMenu.listaPersonas[i].setApellidos( this.campoApellidos.getText() );
                this.ventanaMenu.listaPersonas[i].setTelefono( this.campoTelefono.getText() );
                this.ventanaMenu.listaPersonas[i].setDireccion( this.campoDireccion.getText() );
                this.ventanaMenu.listaPersonas[i].setEmail( this.campoEmail.getText() );
                
                this.ventanaMenu.setVisible(true);
                this.ventanaMenu.alertEditarUsuario();
                dispose();
                break;
            }
        }
    ...
    private void keyCampoBusqueda(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_keyCampoBusqueda
        accionBuscarUsuario();
    }//GEN-LAST:event_keyCampoBusqueda
