...
public class UpdatePerson extends javax.swing.JFrame {
    ...
    public UpdatePerson(InterfazCrud principal, Persona persona) {
    ...
    public void cargarDatosIniciales(){
        campoCedula.setText( persona.getCedula() );
    ...
    private void initComponents() {
        ...
        btnEditar.setPreferredSize(new java.awt.Dimension(105, 27));
        ...
        contentPrincipalLayout.setHorizontalGroup(
            ...
            .addComponent(etqTitulo, javax.swing.GroupLayout.DEFAULT_SIZE, 415, Short.MAX_VALUE)
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if( !cedula.equals("") && !nombres.equals("") && !apellidos.equals("") && !direccion.equals("") && !telefono.equals("") && !email.equals("") ){
            ...
            String respuesta = ConsumoAPI.consumoPOST("http://localhost/02-APIenPHP/Update.php", postData);
